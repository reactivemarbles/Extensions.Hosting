...
/// <summary>Defines a builder interface for configuring and constructing a .NET MAUI application.</summary>
...
public interface IMauiBuilder
{
    ...
    /// <summary>Gets or sets an action that configures the provided <see cref="IMauiContext"/> before it is used.</summary>
    ...
    /// <summary>Gets the builder used to configure and create the .NET MAUI application instance.</summary>
