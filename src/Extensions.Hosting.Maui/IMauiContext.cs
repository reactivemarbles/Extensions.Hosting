...
/// <summary>Provides contextual services and resources for .NET MAUI applications, including access to the current application and dispatcher.</summary>
...
{
    /// <summary>Gets or sets the current .NET MAUI application instance associated with the host environment.</summary>
    ...
    /// <summary>Gets the dispatcher associated with the current context, if any.</summary>
