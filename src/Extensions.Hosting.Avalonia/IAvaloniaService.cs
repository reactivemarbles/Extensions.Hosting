...
/// <summary>Defines methods for initializing and managing Avalonia application services within a host environment.</summary>
...
{
    /// <summary>Initializes the application with the specified configuration settings.</summary>
