...
/// <summary>Provides a context for Avalonia applications, enabling management of application lifetime, shutdown behavior, and access to the Avalonia dispatcher.</summary>
...
{
    /// <summary>Gets or sets this is the Avalonia ShutdownMode used for the Avalonia application lifetime, default is OnLastWindowClose.</summary>
    ShutdownMode ShutdownMode { get; set; }

    /// <summary>Gets or sets the Application.</summary>
    Application? AvaloniaApplication { get; set; }

    /// <summary>Gets or sets the Application Lifetime.</summary>
    IClassicDesktopStyleApplicationLifetime? ApplicationLifetime { get; set; }

    /// <summary>Gets the Avalonia dispatcher.</summary>
