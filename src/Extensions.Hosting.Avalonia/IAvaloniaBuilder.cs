...
/// <summary>
/// Provides a contract for configuring an Avalonia application, including application type, existing application
/// instance, window types, and context and builder configuration actions.
/// </summary>
...
public interface IAvaloniaBuilder
{
    ...
    /// <summary>
    /// Gets or sets action to configure the Avalonia context.
    /// </summary>
    Action<IAvaloniaContext>? ConfigureContextAction { get; set; }

    /// <summary>
    /// Gets or sets action to configure the AppBuilder.
    /// </summary>
