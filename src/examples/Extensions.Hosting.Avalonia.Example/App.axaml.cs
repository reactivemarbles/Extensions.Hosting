...
/// <summary>
/// Represents the main application class for the Avalonia application. Provides the entry point for application
...
{
    /// <summary>
    /// Initializes the component by loading its associated XAML resources.
    /// </summary>
