...
/// <summary>Defines a builder for configuring and creating a named mutex, typically used to enforce single-instance application behavior.</summary>
...
{
    /// <summary>Gets or sets the unique identifier for the mutex associated with the current operation or resource.</summary>
    string? MutexId { get; set; }

    /// <summary>Gets or sets a value indicating whether the setting applies globally to all users or contexts.</summary>
    bool IsGlobal { get; set; }

    /// <summary>Gets or sets the action to execute when the current process is not the first instance of the application.</summary>
