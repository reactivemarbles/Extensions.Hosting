...
/// <summary>Defines a context for Windows Forms operations, providing properties for managing visual styles and dispatching actions to forms.</summary>
...
{
    /// <summary>Gets or sets a value indicating whether visual styles are enabled for the application.</summary>
    ...
    /// <summary>Gets or sets the dispatcher used to manage the execution of operations on a specific thread or context.</summary>
