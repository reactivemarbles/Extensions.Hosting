...
public static class PluginBuilderExtensions
{
    ...
    /// <param name="pluginBuilder">The receiver instance.</param>
    extension(IPluginBuilder pluginBuilder)
    {
        /// <summary>Adds one or more directories to the plugin and framework scan paths for the specified plugin builder.</summary>
        ...
        /// <summary>Excludes plug-in targets that match the specified framework glob patterns from the plug-in builder configuration.</summary>
        ...
        /// <summary>Excludes plugins from discovery by specifying one or more glob patterns.</summary>
        ...
        /// <summary>Includes the specified framework glob patterns in the plugin builder's framework matcher, allowing only matching frameworks to be considered during plugin resolution.</summary>
        ...
        /// <summary>Adds one or more plugin glob patterns to the plugin builder's include list.</summary>
