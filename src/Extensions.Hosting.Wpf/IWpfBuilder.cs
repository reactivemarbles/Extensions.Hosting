...
/// <summary>Defines a contract for configuring and building a WPF application, including application type, application instance, window types, and context configuration actions.</summary>
...
{
    /// <summary>Gets or sets the type of the application associated with this instance.</summary>
    Type? ApplicationType { get; set; }

    /// <summary>Gets or sets the application associated with the current context.</summary>
    Application? Application { get; set; }

    /// <summary>Gets the collection of window types supported by the application.</summary>
    ...
    /// <summary>Gets or sets an action that configures the provided WPF context before it is used.</summary>
