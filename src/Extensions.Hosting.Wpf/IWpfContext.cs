...
/// <summary>Defines a context for WPF-based UI operations, providing access to the application, dispatcher, and shutdown behavior.</summary>
...
{
    /// <summary>Gets or sets the shutdown behavior for the application.</summary>
    ...
    /// <summary>Gets or sets the current WPF application instance associated with the host.</summary>
    Application? WpfApplication { get; set; }

    /// <summary>Gets the dispatcher associated with the current object.</summary>
