...
/// <summary>Defines a context for WinUI-based user interface operations, providing access to the application window, dispatcher, and related WinUI components.</summary>
...
{
    /// <summary>Gets or sets the application window associated with the current context.</summary>
    Window? AppWindow { get; set; }

    /// <summary>Gets or sets the type of the application window to be created or managed.</summary>
    ...
    /// <summary>Gets or sets the dispatcher queue associated with the object.</summary>
    ...
    /// <summary>Gets or sets the current Windows UI Application instance associated with the host.</summary>
