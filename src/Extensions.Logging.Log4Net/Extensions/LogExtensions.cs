...
/// <summary>Provides extension methods for the ILog interface to support logging messages at custom log levels such as Critical and Trace.</summary>
...
public static class LogExtensions
{
    ...
    /// <param name="log">The receiver instance.</param>
    extension(ILog log)
    {
