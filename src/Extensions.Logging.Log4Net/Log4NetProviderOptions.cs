...
/// <summary>The log4Net provider options.</summary>
/// <remarks>
...
{
    /// <summary>The default log4 net file name.</summary>
    private const string DefaultLog4NetFileName = "log4net.config";

    /// <summary>Initializes a new instance of the <see cref="Log4NetProviderOptions"/> class.</summary>
    ...
    /// <summary>Gets or sets the logger repository.</summary>
    public string? LoggerRepository { get; set; }

    /// <summary>Gets or sets the level value that should be used to override default's critical level.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether let user setup log4net externally.</summary>
    public bool ExternalConfigurationSetup { get; set; }

    /// <summary>Gets or sets a value indicating whether let user setup log4net from web.config / app.config.</summary>
    public bool UseWebOrAppConfig { get; set; }

    /// <summary>Gets or sets the assembly used to create the log4net repository identity when <see cref="LoggerRepository"/> is not provided.</summary>
    public Assembly? ConfigurationAssembly { get; set; }

    /// <summary>Gets or sets the factory for the log4net <see cref="log4net.Core.LoggingEvent"/>.</summary>
    public ILog4NetLoggingEventFactory? LoggingEventFactory { get; set; }

    /// <summary>Gets or sets the translator between the <see cref="LogLevel"/> and the log4net <see cref="log4net.Core.Level"/>.</summary>
