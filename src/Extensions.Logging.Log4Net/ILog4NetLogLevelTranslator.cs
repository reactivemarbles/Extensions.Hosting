...
/// <summary>Represents a log level translator between the different logging systems.</summary>
public interface ILog4NetLogLevelTranslator
{
    /// <summary>Translates a <see cref="LogLevel"/> to a log4net <see cref="log4net.Core.Level"/> based on the provided options.</summary>
